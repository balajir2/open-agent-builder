...
export const llmProviders: LLMProvider[] = [
  {
    ...
    models: [
      ...
      },
      {
        ...
        supportsMCP: true,
        maxTokens: 8192,
        description: 'Latest Haiku - fastest, matches Sonnet 3.5 on coding & agents',
      },
    ],
  },
  {
    ...
    models: [
      {
        ...
        inputCostPer1M: 0.00, // Free during experimental phase
        outputCostPer1M: 0.00,
        supportsJSON: true,
        supportsMCP: true,
        maxTokens: 8192,
        description: 'Latest experimental flash model - fast, multimodal, and free',
      },
      {
        id: 'gemini-2-flash',
        ...
        supportsMCP: true,
        maxTokens: 8192,
        description: 'Fast and versatile multimodal model (stable)',
      },
    ],
  },
];
