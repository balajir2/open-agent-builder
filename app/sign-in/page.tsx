...
function SignInContent() {
    ...
    const callbackUrl = searchParams.get("callbackUrl") || "/?view=workflows";
    return (
...
shadow-[0_4px_20px_rgba(99,102,241,0.4)] hover:brightness-110 active:scale-[0.98]
"
                    >
                        {/* Microsoft Logo */}
                        <svg className="w-15 h-15" viewBox="0 0 23 23" fill="none">
